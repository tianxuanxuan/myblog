package com.xgit.boot.common_utils;
...
public class CommonResult {
    ...
    private static CommonResult result= new CommonResult();
    ...
    /**设置值方法*/
    public CommonResult succes(Boolean b){
        this.success=b;
        return this;
    }

    public CommonResult code(Integer i){
        this.code=i;
        return this;
    }
